...
// MFCApplication4.cpp: определяет поведение классов для приложения.
//
...
// Единственный объект CMFCApplication4App

CMFCApplication4App theApp;


// Инициализация CMFCApplication4App
